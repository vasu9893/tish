...
const Dashboard = ({ user, onLogout }) => {
  ...
  if (!user) {
    console.log('⚠️ Dashboard: No user data, showing fallback')
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md">
          <h2 className="text-xl font-bold text-blue-600 mb-4">Dashboard Loading</h2>
          <p className="text-gray-700 mb-4">User data is loading...</p>
  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md">
          <h2 className="text-xl font-bold text-red-600 mb-4">Dashboard Error</h2>
          <p className="text-gray-700 mb-4">An unexpected error occurred while rendering the dashboard.</p>
          <button 
            onClick={() => window.location.reload()} 
            className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
          >
